...
- ❌ Create tutorials using the guide as your script.<br /><small>*That would be commercial use on almost any platform.*</small>

## Content License

The guide content itself is licensed <a href={licenseUrl} class="text-inherit">{license}</a>. 
...
The code that runs the guide website is licensed <a href="https://www.gnu.org/licenses/agpl-3.0.en.html">GNU AFFERO GENERAL PUBLIC LICENSE 3.0</a>.
