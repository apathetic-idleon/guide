...
<Aside>Your character names <Stress>must</Stress> be unique to <Stress>all</Stress> characters in IdleOn.</Aside>
...
<Aside type="tip">To make sure it registers as looted, once you are in-game, drop it (by dragging it from the inventory window to the top of the screen), and pick it back up.</Aside>
